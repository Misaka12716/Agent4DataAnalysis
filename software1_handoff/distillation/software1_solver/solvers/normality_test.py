...
CONTRACT = SolverContract(
    ...
    description=(
        "Run Shapiro-Wilk + Kolmogorov-Smirnov normality tests on each "
        "specified numeric column.  Output: deliverable csv "
        "[column, shapiro_W, shapiro_p, ks_D, ks_p, is_normal_alpha_0.05]"
    ),
    roles={
        "test_columns": RoleSpec(
            Role.NUMERIC_LIST,
            "the numeric columns to test for normality",
        ),
    },
