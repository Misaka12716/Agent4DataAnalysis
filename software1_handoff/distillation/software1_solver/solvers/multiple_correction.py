...
CONTRACT = SolverContract(
    ...
    description=(
        ...
        "of raw p-values.  Output: csv with original p_value plus "
        "p_bonferroni, p_bh_fdr, sig_uncorrected, sig_bonferroni, "
        "sig_bh_fdr (0/1)."
    ),
    roles={
        "test_id_col": RoleSpec(Role.ID, "test identifier"),
